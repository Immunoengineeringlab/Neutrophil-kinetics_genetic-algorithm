...
%"parameters [2500X8] matrix" variable stored in workspace should be used to plot distributions data is stored as 
%rows=individual optimization runs columns= parameters
